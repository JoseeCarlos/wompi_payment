...
class CreditCardPay extends PaymentProcessor {
  ...
  Future<CardPaymentResponse> pay() async {
    ...
    log('CreditCardPay:pay:body: ${json.encode(body)}');
    ...
    log('CreditCardPay:pay:body:Large Url $finalUrl');

    log('CreditCardPay:pay:body:Large ${json.encode(body)}');
    ...
    log('CreditCardPay:pay:response.body: ${response.body}');
